...
// NOTE: Avoid inline object-type generics like useState<{...}>(...) in TSX.
// Some build pipelines can mis-parse `<{` in TSX files and then error later
// at the first JSX return. Using a named type keeps the parser unambiguous.
type ReviewsData = {
  count: number
...
//
// NOTE: Keep the generic type parameters on a single line. Some build pipelines
// can mis-parse multi-line generics in TSX files.
type ChartBoundaryProps = { children: React.ReactNode; title?: string }
type ChartBoundaryState = { hasError: boolean }

class ChartBoundary extends React.Component<ChartBoundaryProps, ChartBoundaryState> {
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="card p-6 mb-6">
          <div className="flex flex-col lg:flex-row lg:items-start gap-6">
            ...
            <div className="flex-shrink-0 flex flex-col items-center">
              ...
              <p className="text-xs text-[#64748b] mt-1">0 = worst • 100 = best</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {[
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl border border-[#1e293b] bg-[#151c2c] text-sm text-[#94a3b8] hover:text-white hover:border-blue-500/40 transition-colors"
            >
              {item.label}
            </button>
          ))}
        ...
        {/* Overview */}
          <section id="overview" className="space-y-6 animate-fade-in">
            ...
            <div className="card p-6 border-2 border-yellow-500/30 bg-gradient-to-r from-yellow-500/5 to-orange-500/5 cursor-pointer hover:border-yellow-500/50 transition-colors" onClick={() => { document.getElementById('reviews')?.scrollIntoView({ behavior: 'smooth', block: 'start' }) }}>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  <button onClick={(e) => { e.stopPropagation(); setShowReviewForm(true); document.getElementById('reviews')?.scrollIntoView({ behavior: 'smooth', block: 'start' }) }} className="px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-black font-semibold rounded-lg flex items-center gap-2">
            ...
            <div className="card p-6">
              ...
              <p className="text-sm text-[#64748b] mb-4">Scroll for details. These are the highest-signal checks.</p>
        ...
        <section id="issues" className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-1">
              <h2 className="text-xl font-bold">Issues</h2>
              <div className="text-sm text-[#64748b]">Violations and hazards</div>
            </div>
        ...
        <section id="landlord" className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-1">
              <h2 className="text-xl font-bold">Landlord</h2>
              <div className="text-sm text-[#64748b]">Who owns it and their record</div>
            </div>
            {/* Key Stats */}
        ...
        <section id="announcements" className="card p-6 animate-fade-in">
        ...
        <section id="permits" className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-1">
              <h2 className="text-xl font-bold">Permits</h2>
              <div className="text-sm text-[#64748b]">Construction and DOB filings</div>
            </div>
        ...
        <section id="sales" className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-1">
              <h2 className="text-xl font-bold">Sales</h2>
              <div className="text-sm text-[#64748b]">Ownership history and transactions</div>
            </div>
        ...
        <section id="complaints" className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-1">
              <h2 className="text-xl font-bold">Complaints</h2>
              <div className="text-sm text-[#64748b]">311, HPD, and DOB reports</div>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <section id="reviews" className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-1">
              <h2 className="text-xl font-bold">Reviews</h2>
              <div className="text-sm text-[#64748b]">Resident experiences</div>
            </div>
            {/* Reviews Summary */}
            <div className="card p-6">
        ...
        <section id="neighborhood" className="space-y-6 animate-fade-in">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-1">
              <h2 className="text-xl font-bold">Neighborhood</h2>
              <div className="text-sm text-[#64748b]">Safety, livability, and risk</div>
            </div>
            {/* Neighborhood Score */}
            <div className="card p-6">
            ...
            <div className="card p-6">
              ...
              <div className="grid sm:grid-cols-4 gap-4 mb-4">
                ...
                <div className="p-3 bg-[#1a2235] rounded-xl text-center">
                  ...
                  <div className="text-xs text-[#64748b]">Safety Score (0–100)</div>
                </div>
                <div className="p-3 bg-[#1a2235] rounded-xl text-center">
            ...
            <div className="card p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4 mb-4">
                ...
                <div className="p-3 bg-[#1a2235] rounded-xl text-center"><div className="text-2xl font-bold" style={{ color: data.crime?.score >= 70 ? '#10b981' : data.crime?.score >= 50 ? '#f59e0b' : '#ef4444' }}>{(data.crime?.score ?? 0)}%</div><div className="text-xs text-[#64748b]">Safety Score (0–100)</div></div>
              </div>
